        ...
        <div className="page-layout">
            <div class="uredi-container" style={{ maxWidth: "800px" }}>
                ...
                <div class="form-grid">
                    ...
                    <input
                        placeholder="Ukratko"
                        value={noviArtikl.ukratko}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                ukratko: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Baterija"
                        value={noviArtikl.baterija}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                baterija: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Zaslon"
                        value={noviArtikl.zaslon}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                zaslon: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Težina"
                        value={noviArtikl.tezina}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                    ...
                    <input
                        placeholder="Okvir"
                        value={noviArtikl.okvir}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                okvir: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Pogon"
                        value={noviArtikl.pogon}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                pogon: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Suspenzija"
                        value={noviArtikl.suspenzija}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                suspenzija: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Kotači"
                        value={noviArtikl.kotaci}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                kotaci: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Kočnice"
                        value={noviArtikl.kocnice}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                kocnice: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Gume"
                        value={noviArtikl.gume}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                gume: e.target.value,
                    ...
                    <input
                        placeholder="Pribor"
                        value={noviArtikl.pribor}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                pribor: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Sastav"
                        value={noviArtikl.sastav}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                sastav: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Skladištenje"
                        value={noviArtikl.skladistenje}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                skladistenje: e.target.value,
                            })
                        }
                    />
                    <input
                        placeholder="Ograničenje"
                        value={noviArtikl.ogranicenje}
                        onChange={(e) =>
                            setNoviArtikl({
                                ...noviArtikl,
                                ogranicenje: e.target.value,
                            })
                        }
                    />
                    ...
                    <button className="slatkis" onClick={dodajArtikl}>
                        ➕ Dodaj
                    </button>
                    <h3 style={{ fontSize: "35px" }}>📦 Postojeći artikli</h3>
                    <ul style={{ fontSize: "25px" }}>
                        {artikli.map((a) => (
                            <li className="artikl-item" key={a.id}>
                                <p>
                                    <strong>{a.name}</strong> – {a.cijena} €
                                </p>
                                <div className="artikl-button-wrapper">
                                    <button
                                        style={{ margin: "3px" }}
                                        className="slatkis"
                                        onClick={() => obrisiArtikl(a.id)}
                                    >
                                        🗑 Obriši
                                    </button>
                                    <Link to={`/admin/uredi/${a.id}`}>
                                        <button className="slatkis">
                                            ✏️ Uredi
                                        </button>
                                    </Link>
                                </div>
