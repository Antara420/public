...
const Kosarica = () => {
    ...
    return (
        <div className="page-layout">
                                    ...
                                    <li key={index}>
                                      ...
                                      <div className="item-info">
                                          ...
                                          <div className="quantity-controls">
                                              <button onClick={() => smanjiKolicinu(p.id)}>
                                                  -
                                              </button>
                                              <span>{p.kolicina}</span>
                                              <button onClick={() => povecajKolicinu(p.id) } disabled={ p.kolicina >= MAX_KOLICINA}
                                              >
                                                  +
                                              </button>
                                          </div>
            ...
            <div className="site-footer">&copy; 2025</div>
        </div>
    );
};
